      ...
      sidebar: [
        {
          ...
          items: [
            "python",
            {
              label: "Le basi",
              collapsed: false,
              items: [{ autogenerate: { directory: "python/basics" } }],
            },
            {
              label: "Strutture dati",
              collapsed: false,
              items: [{ autogenerate: { directory: "python/data-structures" } }],
            },
            {
              label: "Controllo del flusso",
              collapsed: false,
              items: [{ autogenerate: { directory: "python/flow-control" } }],
            },
            {
              label: "Funzioni",
              collapsed: false,
              items: [{ autogenerate: { directory: "python/functions" } }],
            },
            {
              label: "Programmazione a oggetti",
              collapsed: true,
              items: [{ autogenerate: { directory: "python/oop" } }],
            },
            {
              label: "Moduli e libreria standard",
              collapsed: true,
              items: [{ autogenerate: { directory: "python/modules-and-stdlib" } }],
            },
            {
              label: "Input e output",
              collapsed: true,
              items: [{ autogenerate: { directory: "python/input-output" } }],
            },
            {
              label: "Gestione degli errori",
              collapsed: true,
              items: [{ autogenerate: { directory: "python/errors" } }],
            },
            {
              label: "Tecniche avanzate",
              collapsed: true,
              items: [{ autogenerate: { directory: "python/advanced" } }],
            },
            {
              label: "Ecosistema Python",
              collapsed: true,
              items: [{ autogenerate: { directory: "python/ecosystem" } }],
            },
            {
              label: "Grafica e interfacce",
              collapsed: true,
              items: [{ autogenerate: { directory: "python/graphics" } }],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            "cpp",
            {
              label: "Le basi",
              collapsed: false,
              items: [{ autogenerate: { directory: "cpp/basics" } }],
            },
            {
              label: "Input e output",
              collapsed: false,
              items: [{ autogenerate: { directory: "cpp/input-output" } }],
            },
            {
              label: "Controllo del flusso",
              collapsed: false,
              items: [{ autogenerate: { directory: "cpp/flow-control" } }],
            },
            {
              label: "Strutture dati",
              collapsed: true,
              items: [{ autogenerate: { directory: "cpp/data-structures" } }],
            },
            {
              label: "Funzioni",
              collapsed: true,
              items: [{ autogenerate: { directory: "cpp/functions" } }],
            },
            {
              label: "Memoria e puntatori",
              collapsed: true,
              items: [{ autogenerate: { directory: "cpp/memory" } }],
            },
            {
              label: "Programmazione a oggetti",
              collapsed: true,
              items: [{ autogenerate: { directory: "cpp/oop" } }],
            },
            {
              label: "Tecniche avanzate",
              collapsed: true,
              items: [{ autogenerate: { directory: "cpp/advanced" } }],
            },
            {
              label: "Strumenti e tecniche",
              collapsed: true,
              items: [{ autogenerate: { directory: "cpp/tools" } }],
            },
          ],
        },
      ],
