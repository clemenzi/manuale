...
I programmi lavorano anche con parole, frasi e messaggi. Le **stringhe** rappresentano questo testo.

In C++ moderno si usa il tipo `string`, che offre operazioni per costruire e modificare il testo.
...
Come negli array, puoi leggere o modificare un carattere con un indice tra `[]`. Gli indici partono da 0:

```cpp
string nome = "Alice";
cout << nome[0] << endl;  // A: il primo carattere
cout << nome[1] << endl;  // l
cout << nome[4] << endl;  // e: il quinto (e ultimo) carattere
