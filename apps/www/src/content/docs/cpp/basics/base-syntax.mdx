...
Ogni istruzione in C++ deve terminare con un **punto e virgola** (`;`). Segnala al compilatore che l'istruzione è terminata.
...
Usa 4 spazi (o un tab) per ogni livello di indentazione. Una formattazione coerente rende il codice più facile da leggere.
