...
In Python puoi eseguire direttamente il codice. In C++ devi prima passare dalla **compilazione**.

Il compilatore legge il codice, lo traduce e produce un eseguibile che puoi avviare in seguito.

Il codice compilato viene eseguito direttamente dal processore e, in molti casi, è più veloce del codice Python.

---

## Installare il compilatore GCC

**GCC** (GNU Compiler Collection) è un compilatore C++ gratuito e open source.
...
VS Code è un editor di testo gratuito che puoi usare per scrivere e compilare il codice.
