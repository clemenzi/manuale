...
Le **variabili** sono i nomi associati ai valori che il programma conserva e può aggiornare durante l'esecuzione.
...
Dopo la dichiarazione, una variabile locale non inizializzata contiene un valore indeterminato.

## Inizializzare una variabile

**Inizializzare** significa assegnare il primo valore mentre dichiari la variabile:
...
Questa forma consente controlli più severi sulle conversioni e può evitare perdita di dati.
...
// Nomi non validi
int 2x;          // ERRORE: inizia con un numero
...
In Python questo causa un errore chiaro. In C++ il compilatore potrebbe non avvertire e il programma può produrre risultati imprevedibili.
