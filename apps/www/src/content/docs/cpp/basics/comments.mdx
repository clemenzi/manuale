...
Quando rileggi codice scritto tempo prima, un commento può ricordarti perché una scelta era necessaria.
...
Un commento è utile quando aggiunge un'informazione che il codice non rende evidente.
...
È un modo rapido per escludere temporaneamente una parte durante il debug.
