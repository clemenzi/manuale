---
title: Iteratori in C++
description: Introduzione agli iteratori della STL in C++.
---

## Cos'è un iteratore?

Gli algoritmi della STL, come `sort`, `find` e `count`, ricevono **iteratori** che delimitano la sequenza su cui lavorare.

Capire gli iteratori permette di usare questi algoritmi e di percorrere i contenitori quando un range-based `for` non basta.

## Cosa sono gli iteratori

Un iteratore rappresenta una posizione nel contenitore e può avanzare o arretrare.
...
`end()` non punta a un elemento reale: rappresenta la posizione oltre l'ultimo elemento.
