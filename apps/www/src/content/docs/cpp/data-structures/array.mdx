...
Per memorizzare i voti di 30 studenti, trenta variabili separate come `voto1` e `voto2` renderebbero il codice difficile da gestire.

Un **array** contiene una sequenza di valori dello stesso tipo sotto un unico nome. Ogni elemento si raggiunge tramite il suo **indice**.
...
Gli indici devono essere compresi tra `0` e `dimensione - 1`.
