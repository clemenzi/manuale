...
Alcuni dati sono organizzati naturalmente in una **griglia**, per esempio voti, celle di una scacchiera o pixel di un'immagine.

Un **array bidimensionale** rappresenta una tabella di righe e colonne; servono due indici per raggiungere una cella.
...
Per visitare tutti gli elementi di una matrice servono due cicli `for` annidati: uno per le righe e uno per le colonne:
