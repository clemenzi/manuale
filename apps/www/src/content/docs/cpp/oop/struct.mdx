...
Per registrare 30 studenti potresti usare tre array separati per nomi, età e voti, ma dovresti mantenerli sincronizzati.

Una **struttura** (`struct`) raggruppa queste informazioni in un unico tipo. Puoi così creare un array di studenti.
...
Puoi inizializzare tutti i campi in una sola riga:
...
Le strutture possono essere passate alle funzioni come le altre variabili:
