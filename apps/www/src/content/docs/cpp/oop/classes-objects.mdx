...
Considera una classe scolastica con 30 studenti, ciascuno con nome, età e voti.

Senza classi dovresti coordinare molti gruppi di variabili. Una classe definisce invece i dati e le operazioni di uno studente, da cui puoi creare più oggetti.

## Classe vs Oggetto: lo stampo e il prodotto

Una **classe** descrive la struttura e le operazioni disponibili, ma non rappresenta ancora un elemento concreto.

Un **oggetto** è un'istanza della classe, con i propri valori.
