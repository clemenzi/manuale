...
Supponi di dover invocare lo stesso metodo su cani, gatti e mucche. Senza polimorfismo dovresti distinguere ogni tipo.

Con il **polimorfismo**, puoi conservare gli oggetti in una stessa lista e lasciare che ciascuno esegua la propria versione di `emettiSuono`.

Polimorfismo significa "molte forme": lo stesso metodo può avere comportamenti diversi in base all'oggetto.
...
Il comportamento si vede quando usi un **puntatore alla classe madre** per gestire oggetti di classi figlie diverse:
