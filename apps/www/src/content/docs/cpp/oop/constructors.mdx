...
Se una classe non inizializza i propri campi, alcuni membri possono contenere valori indeterminati. Usarli prima di assegnarli produce risultati imprevedibili.

Il **costruttore** è una funzione speciale chiamata **automaticamente** quando crei un oggetto; inizializza i suoi membri.
...
La lista inizializza i campi direttamente, senza una successiva assegnazione nel corpo del costruttore.
