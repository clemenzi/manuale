...
L'**incapsulamento** separa l'interfaccia pubblica dai dettagli interni di una classe.

In pratica, dichiari i dati **privati** e fornisci metodi pubblici per leggerli o modificarli secondo regole definite dalla classe.

## Il problema senza incapsulamento

Quando i dati sono pubblici, il codice esterno può assegnare qualsiasi valore:
...
L'incapsulamento permette di cambiare l'implementazione interna **senza modificare il codice che usa la classe**:
