...
Per calcolare l'area di forme diverse potresti usare nomi diversi, oppure mantenere il nome `area` e distinguere le funzioni con i parametri.

In C++ questo si chiama **overloading** (sovraccarico): più funzioni possono avere lo stesso nome se la loro lista di parametri è diversa.
