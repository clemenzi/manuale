...
Durante lo scorrimento di una lista puoi dover interrompere la ricerca oppure saltare alcuni elementi.

`break` e `continue` controllano il passaggio da un'iterazione alla successiva.
