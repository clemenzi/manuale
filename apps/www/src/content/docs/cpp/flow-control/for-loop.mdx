...
Per stampare i numeri da 1 a 100 non serve scrivere cento istruzioni separate.

Il ciclo `for` ripete un blocco di codice controllando inizializzazione, condizione e aggiornamento.
...
In questo esempio il contatore parte da zero, aumenta di uno e si ferma prima di arrivare a cinque.
...
In C++ moderno puoi usare una forma di `for` che visita gli elementi di una lista o di una stringa senza gestire manualmente l'indice:
