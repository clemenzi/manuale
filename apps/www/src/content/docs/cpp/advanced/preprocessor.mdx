...
## Aggiungere altri file con `#include`
...
## Creare una sostituzione automatica con `#define`
...
## Cancellare una scorciatoia con `#undef`
...
## Generare un errore personalizzato con `#error`
