...
Un **puntatore** non contiene direttamente il valore: contiene l'**indirizzo** della memoria in cui il valore si trova.

Il puntatore può quindi essere usato per leggere o modificare quel valore tramite la sua **posizione in memoria**.
...
La RAM assegna un indirizzo alle aree in cui conserva i dati. Ogni variabile occupa una di queste aree.
...
La dereferenziazione accede quindi al valore memorizzato all'indirizzo.
