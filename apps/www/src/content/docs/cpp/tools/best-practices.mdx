...
Il codice dovrebbe funzionare, ma anche essere leggibile e modificabile senza introdurre errori.

Queste abitudini aiutano a:
...
Tratta l'input dell'utente come un dato da verificare:
...
DRY significa "Don't Repeat Yourself". Se la stessa logica compare in più punti, estraila in una funzione:
