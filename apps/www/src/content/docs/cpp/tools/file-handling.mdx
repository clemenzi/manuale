...
Quando il programma termina, le variabili non conservano i dati. Per **conservare i dati** devi scriverli su un file.

I file permettono anche di leggere dati preparati in anticipo.
...
Il codice crea `saluto.txt` nella cartella di esecuzione. Se il file esiste già, viene **sovrascritto**.
