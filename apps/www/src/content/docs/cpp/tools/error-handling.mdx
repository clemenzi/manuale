...
Un programma può ricevere input errati, non trovare un file o tentare un'operazione impossibile, come una divisione per zero.

La **gestione degli errori** consiste nel rilevare queste situazioni e scegliere come segnalarle o recuperare.
...
Controlla l'input prima di usarlo:
...
Le **eccezioni** gestiscono errori che interrompono il flusso normale. Usano `try`, `catch` e `throw`.
