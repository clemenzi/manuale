...
I bug fanno parte dello sviluppo. Il debugging consiste nel riprodurli, capire la causa e correggere il codice.

Le tecniche seguenti aiutano a restringere il punto in cui nasce il problema.
...
Correggi prima il **primo** errore della lista: gli errori successivi possono dipendere da quello.
...
Non ignorarli: possono segnalare codice che produce risultati inattesi.
