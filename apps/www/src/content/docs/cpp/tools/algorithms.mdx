...
Un **algoritmo** è una sequenza di passi definiti per risolvere un problema.

Gli algoritmi di base aiutano a valutare il lavoro svolto dal codice e il numero di operazioni necessarie.
...
Questi esempi mostrano come descrivere un procedimento e confrontarne il costo.
