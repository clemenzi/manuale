...
Apri la cartella con l'editor e aggiungi un file chiamato:
...
Se vedi il codice con i simboli `<` e `>`, controlla l'estensione del file. Se vedi una pagina vecchia, assicurati di aver salvato e premi il pulsante di ricarica del browser.
...
Questo è il ciclo di lavoro che userai spesso:
