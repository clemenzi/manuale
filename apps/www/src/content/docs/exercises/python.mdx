...
Il testo digitato viene salvato nella variabile `nome`.
...
La parola viene cercata tra gli elementi della lista.
...
`fattoriale` parte da 1 e viene aggiornato a ogni moltiplicazione.
