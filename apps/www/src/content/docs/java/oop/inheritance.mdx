...
L'ereditarietà permette di creare una classe partendo da un'altra.

La classe più generale contiene dati e metodi comuni. La classe più specifica li riusa e aggiunge ciò che le serve.
