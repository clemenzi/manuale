...
L'input e cio che entra nel programma. Nei primi esempi leggeremo dati dalla tastiera.
...
Il programma potrebbe saltare la richiesta del nome. Succede perche `nextInt()` legge il numero, ma lascia nel buffer il carattere di a capo.
