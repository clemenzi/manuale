...
Una **variabile** è una scatola con un'etichetta. L'etichetta è il nome della variabile; il contenuto è il valore salvato.
...
Quando Java vede `nome`, usa il valore salvato nella variabile.
...
La prima parola inizia con una minuscola; le parole successive con una maiuscola.
