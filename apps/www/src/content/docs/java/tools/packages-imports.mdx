...
## Perché organizzare il codice

Quando un progetto contiene poche classi, puoi tenerle nella stessa cartella.

Quando il progetto cresce, serve ordine. I **package** aiutano a raggruppare classi collegate.

Un package è una cartella logica per il codice.
...
Per l'uso quotidiano è una scrittura troppo lunga.
...
Non creare package solo per complicare il progetto: devono aiutare a trovare il codice.
