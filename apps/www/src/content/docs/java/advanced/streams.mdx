...
Uno stream è un modo per lavorare su una sequenza di dati dichiarando il risultato che vuoi ottenere.
...
`Mina` ha 4 caratteri, quindi non soddisfa la condizione `> 4`.

## Collezione e stream

Una collezione, come `ArrayList`, contiene i dati.
