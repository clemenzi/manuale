...
Quando hai più casi, usa `else if`.
...
`switch` è comodo quando confronti una variabile con più valori precisi.
...
Le condizioni permettono al programma di reagire ai dati invece di eseguire sempre la stessa sequenza.
