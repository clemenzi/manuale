...
A volte un ciclo deve fermarsi prima della fine.
...
Usale con misura: in alcuni casi semplificano il codice, ma troppe interruzioni rendono il flusso difficile da seguire.
