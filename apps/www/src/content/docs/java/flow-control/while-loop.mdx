---
title: Ciclo while
description: Come ripetere istruzioni finché una condizione resta vera.
---
...
`numero` resta sempre `1`, quindi la condizione è sempre vera.
...
`!password.equals("java")` significa: "la password non è uguale a java".
...
Qui non viene stampato nulla, perché la condizione è falsa già all'inizio.
