---
title: Overloading
description: Come definire più metodi con lo stesso nome ma parametri diversi.
---
...
Il nome `totale` resta lo stesso perché l'idea è la stessa. Cambiano solo i dati disponibili.
