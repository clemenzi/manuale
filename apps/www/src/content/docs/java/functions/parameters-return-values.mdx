...
Per salutare nomi diversi, usiamo un **parametro**.
...
Se un metodo deve produrre un risultato, devi indicare il tipo restituito.
...
Il secondo numero mostra una piccola imprecisione tipica dei numeri decimali nei computer. È un comportamento possibile con questo tipo di valori.
