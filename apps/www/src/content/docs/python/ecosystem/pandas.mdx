...
Supponi di avere un foglio Excel con migliaia di righe. Trovare gli studenti con media superiore all'8, ordinarli per cognome e salvare il risultato a mano richiederebbe molto tempo.

Con **Pandas** puoi eseguire queste operazioni in poche righe di Python e ripeterle quando i dati cambiano.

## Cos'è Pandas?

**Pandas** è una libreria Python per lavorare con **dati tabellari**, organizzati in righe e colonne come in un foglio Excel o in una tabella di database.
...
Un **DataFrame** rappresenta una tabella con righe e colonne denominate.
...
Pandas legge e scrive direttamente file CSV ed Excel.
