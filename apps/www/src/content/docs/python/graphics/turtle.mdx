...
## Perché usare Turtle per imparare

Turtle mostra il risultato del codice in forma visiva. Invece di stampare numeri nel terminale, puoi disegnare figure sullo schermo.

È utile anche per esercitarsi con cicli e geometria.

---

## Cos'è Turtle?

**Turtle** è una libreria inclusa in Python. Controlli una "tartaruga" virtuale sullo schermo; quando si muove con la penna abbassata, lascia una traccia.

L'idea deriva dal linguaggio Logo degli anni '60, usato per insegnare la programmazione ai bambini.
...
Servono per spostarsi in un altro punto senza lasciare tracce.
...
Questo esempio combina un ciclo, colori e geometria:
...
Modifica l'angolo (91°) o il numero di passi (100) per cambiare il disegno.
