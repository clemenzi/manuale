...
Per impostazione predefinita le date vengono mostrate nel formato `2024-01-15`. Con `strftime()` puoi scegliere il formato del testo:
...
Le date si confrontano come i numeri, usando `<`, `>` e `==`:
