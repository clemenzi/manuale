...
Se descrivi cani, gatti e uccelli, alcune operazioni sono comuni: tutti respirano e mangiano, ma producono suoni diversi.

Con l'**ereditarietà** scrivi il codice comune nella classe "genitore". Le classi "figlie" lo ereditano e aggiungono le proprie caratteristiche.

## La metafora della famiglia

L'analogia con l'ereditarietà biologica è questa:
...
In programmazione il principio è simile.
...
La classe figlia può **ridefinire** un metodo del genitore e cambiarne il comportamento.
