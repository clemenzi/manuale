---
title: Iteratori in Python
description: Come funzionano gli iteratori in Python.
---

## Perché conoscere gli iteratori

Quando scrivi `for elemento in lista`, Python usa un meccanismo chiamato **iteratore**. Capirlo permette di creare sequenze personalizzate, anche capaci di generare dati solo quando servono.
...
Puoi creare una classe iteratore implementando due metodi speciali:
...
Una classe iteratore completa funziona, ma richiede parecchio codice. I **generatori** permettono di ottenere lo stesso risultato in modo più breve.
...
Supponi di dover lavorare con un milione di numeri:
