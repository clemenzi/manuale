...
## Quando il volume dei dati aumenta
...
Con più dati, organizzazione, tempi e strumenti possono cambiare molto.
...
**Con molti dati, le scorciatoie possono diventare costose.**
...
Una soluzione deve continuare a funzionare anche quando il volume aumenta.

:::tip
Quando progetti una tabella, chiediti anche come verrà letta tra un anno, non solo come viene scritta oggi.
:::
