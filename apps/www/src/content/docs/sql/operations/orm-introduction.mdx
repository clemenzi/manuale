...
## Un ORM collega il codice al database
...
Il codice usa oggetti o metodi dell'ORM; l'ORM genera le query che il database esegue.
...
Un ORM semplifica l'accesso, ma non sostituisce la comprensione di SQL.
