...
Da sole mostrano informazioni parziali; insieme permettono di sapere **chi ha comprato cosa**.

Le `JOIN` collegano tabelle diverse mentre leggi i dati.
...
Il risultato contiene solo i nomi presenti in entrambe le liste.
...
Il nome della tabella chiarisce a quale `id` ti riferisci.
