...
**Non tutte le join collegano due tabelle diverse.** A volte una tabella va collegata a se stessa; altre volte servono tutte le combinazioni tra due insiemi.
