...
## Dare un nome a un risultato intermedio
...
Puoi separare un passaggio della query, assegnargli un nome e usarlo nella parte successiva.
...
Separare i passaggi rende più chiaro il ragionamento.
...
Scegli lo strumento che descrive più chiaramente il ragionamento.
