...
## Rappresentare un dato mancante
...
La colonna esiste, ma per quella riga non è disponibile alcun valore.
...
Questa query non funziona come previsto:
...
La condizione corretta chiede se l'email manca, non se è uguale a un valore chiamato `NULL`.
...
Consideralo semplicemente un dato mancante o sconosciuto.
