...
È come cercare in una rubrica solo le persone che vivono a Roma.
...
SQL valuta la condizione una riga alla volta.
...
La query ha controllato tutte le righe e ha mantenuto quella in cui `totale > 100` era vero.
...
Non serve impararli tutti subito: li incontrerai spesso nelle query.
