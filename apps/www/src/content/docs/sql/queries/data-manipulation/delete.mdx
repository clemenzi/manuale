...
Non elimina la tabella: rimuove le righe selezionate dal filtro.
...
Con `DELETE`, `WHERE` stabilisce quali righe verranno rimosse.
...
In alcuni casi non conviene eliminare davvero una riga.
