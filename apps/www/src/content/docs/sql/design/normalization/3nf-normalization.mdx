...
## Evitare le dipendenze indirette
...
In pratica, evita dipendenze indirette che creano duplicazioni e incoerenze.

Considera una scheda cliente con `cap` e `citta`. Se la città dipende dal CAP, e il CAP dal cliente, hai una dipendenza indiretta.
...
Se un dato sta nel posto giusto, quando cambia lo aggiorni una volta sola. **È uno dei vantaggi principali della normalizzazione.**
