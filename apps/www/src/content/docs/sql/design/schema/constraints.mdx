...
Servono a rifiutare dati mancanti, duplicati o incoerenti prima che vengano salvati.

## I vincoli più comuni

Quelli che incontrerai più spesso sono:
...
I vincoli impongono queste regole:
...
In altre parole, se non specifichi un valore, viene usato quello predefinito.
