...
`#include` dice al preprocessore: _"Copia il contenuto di questo file e mettilo qui."_
...
`#define` è come creare una scorciatoia: dici al preprocessore _"ogni volta che vedi questa parola, sostituiscila con quest'altra"_.
...
Puoi dire al preprocessore: _"includi questa parte di codice solo se questa condizione è vera"_.
