...
`int` richiede un numero intero. `"venti"` e una stringa.
...
Un errore a runtime succede mentre il programma e gia in esecuzione.
...
Vai alla riga 4 e controlla cosa succede li.
