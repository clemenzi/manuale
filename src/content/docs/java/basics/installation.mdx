...
Per programmare in Java ti serve il **JDK**, cioe il Java Development Kit.
...
Puoi usare un JDK moderno, per esempio una versione LTS, cioe con supporto a lungo termine.
...
Se Java e installato, vedrai un numero di versione.
...
Puoi scrivere Java con molti editor. Per iniziare, Visual Studio Code va bene perche e leggero e gratuito.
