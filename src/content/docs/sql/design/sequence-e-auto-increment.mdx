...
> **Nota:** Se vedi salti nei numeri, non è per forza un problema. Gli identificatori automatici servono a distinguere le righe, non a contare perfettamente senza buchi.
