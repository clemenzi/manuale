...
> **Suggerimento:** Prima di aggiungere tanti indici, osserva quali query sono davvero lente. Un indice scelto bene aiuta. Dieci indici scelti a caso possono creare solo rumore.
