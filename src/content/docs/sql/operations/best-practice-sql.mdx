...
> **Attenzione:** La pratica più importante con `UPDATE` e `DELETE` è controllare prima il filtro. Sono comandi utili, ma possono fare molti danni se usati senza attenzione.
