...
1. [Cos'è SQL](/sql/basics/cos-e-sql/)
2. [Database relazionali](/sql/basics/database-relazionali/)
3. [Tipi di dati](/sql/basics/tipi-di-dati/)
4. [CREATE DATABASE](/sql/basics/create-database/)
5. [CREATE TABLE](/sql/basics/create-table/)
6. [INSERT](/sql/queries/manipolazione/insert/)
7. [SELECT](/sql/queries/lettura/select/)
8. [WHERE](/sql/queries/lettura/where/)

Poi puoi affrontare [JOIN](/sql/queries/join-sottoquery/join/), [GROUP BY](/sql/queries/aggregazione/group-by/), [indici](/sql/design/indici/create-index/) e [transazioni](/sql/transactions/transazioni/).
